    ...
    <Layout>
      <div className="flex flex-col items-center mb-8 mx-auto min-h-[calc(100%-64px)] max-w-5xl mt-8 gap-4">
        <div className='flex flex-col justify-center w-4/5 gap-2'>
          <button className='flex justify-center w-full p-2 rounded bg-slate-800 hover:bg-slate-700 border border-solid border-slate-500 font-oswald text-zinc-50'
          onClick={() => logout()}>
            Logout
          </button>
        </div>
        ...
        <div className='flex flex-col justify-center w-4/5 gap-2 bg-zinc-600 p-2 border border-solid border-slate-500'>
          ...
          <button className='flex justify-center w-full p-2 rounded bg-rose-800 hover:bg-rose-700 border border-solid border-rose-500 font-oswald text-zinc-50'
