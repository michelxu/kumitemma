...
const Card = ({id}) => {
  ...
  const cardClass = `flex flex-col w-48 h-64 rounded-lg select-none border-solid border-2 relative
  ${cardTypeClasses[fighter.card_type].bg} `

  const cardName = `text-center text-xl font-poppins italic tracking-tighter
